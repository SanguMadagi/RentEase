                    ...
                    <Card className="shadow-lg border-0">
                        <Card.Body className="p-5">
                            <div className="text-center mb-4">
                                ...
                                <h2 className="fw-bold text-primary mb-2">Aadhaar Verification</h2>
                            ...
                            <Alert variant="info" className="mt-4 mb-0">
                                <small>
                                    <strong>Note:</strong> This is a demo application. In production, Aadhaar verification 
                                    would be done through official UIDAI APIs with proper encryption and security measures.
                                </small>
                            </Alert>
                        </Card.Body>
                    </Card>
