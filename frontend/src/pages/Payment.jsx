  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="bg-white shadow-xl rounded-2xl p-8 sm:p-10 w-full max-w-lg border border-slate-100 flex flex-col items-center">
        ...
        {/* Demo Payment Notice */}
        <div className="w-full bg-blue-50/75 border border-blue-200 rounded-xl p-4 mb-6 text-left flex gap-3">
          <span className="text-blue-500 text-base flex-shrink-0 mt-0.5">ℹ️</span>
          <div className="space-y-1.5">
            <h4 className="text-xs font-bold text-blue-900">Demo Payment Environment</h4>
            <p className="text-[11px] leading-relaxed text-blue-800">
              This payment flow is currently simulated for demonstration and portfolio purposes. No real money is charged and no actual payment gateway is connected.
            </p>
            <p className="text-[11px] leading-relaxed text-blue-800">
              In the production version, this module will be integrated with secure payment gateways such as Razorpay or Stripe, including payment verification, webhook handling, and transaction history.
            </p>
          </div>
        </div>
